...
class DeteriorationAssessment(Base):
    ...
    trend: Mapped[str] = mapped_column(String(16), nullable=False, comment="improving, stable, worsening, none")
    criteria: Mapped[list[dict]] = mapped_column(JSONB, nullable=False, comment="DeteriorationCriteria dicts")
