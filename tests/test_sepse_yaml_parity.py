...
GOLDEN_VECTORS: list[Vector] = [
    ...
    Vector(
        "screen-tv1-fire-qsofa-infection",
        "crit-sep-screen",
        {
            "qsofa": 2,
    ...
    Vector(
        "screen-tv3-no-fire-sirs-no-infection",
        "crit-sep-screen",
        {
            "temperatura": 38.6,
            "frequencia_cardiaca": 112,
    ...
    Vector(
        "screen-tv4-boundary-exact-no-fire",
        "crit-sep-screen",
        {
    ...
    Vector(
        "screen-tv5-boundary-just-above-fires",
        "crit-sep-screen",
        {
    ...
    Vector(
        "organ-tv1-fire-qsofa-lactate-high",
        "crit-sep-organ",
    ...
    Vector(
        "organ-tv2-no-fire-lactate-below-trend-weak",
        "crit-sep-organ",
    ...
    Vector(
        "organ-tv4-boundary-lactate-2-0-no-fire",
        "crit-sep-organ",
    ...
    Vector(
        "organ-tv5-boundary-lactate-2-01-fires",
        "crit-sep-organ",
    ...
    Vector(
        "shock-tv2-fire-map-low-on-vasopressor",
        "crit-sep-shock",
    ...
    Vector(
        "shock-tv3-no-fire-map-low-no-vasopressor",
        "crit-sep-shock",
        {
    ...
    Vector(
        "shock-tv4-boundary-lactate-4-0-fires",
        "crit-sep-shock",
    ...
    Vector(
        "shock-tv5-boundary-map-65-no-fire",
        "crit-sep-shock",
    ...
    Vector(
        "bundle-tv1-fire-overdue-primeira-hora",
    ...
    Vector(
        "bundle-tv2-no-fire-item-already-checked",
        "crit-sep-bundle-atb-1h",
        {
            "protocol_active": True,
            "item_checked": True,
    ...
    Vector(
        "bundle-tv4-boundary-exactly-60-min-no-fire",
        "crit-sep-bundle-atb-1h",
        {
            "protocol_active": True,
            "item_checked": False,
    ...
    Vector(
        "bundle-tv3-no-fire-reavaliacao-not-yet-due",
        ...
        _eval_bundle_overdue_04,
        _adapt_bundle_reaval,
    ),
    Vector(
        "bundle-tv5-boundary-181-min-fires",
        "crit-sep-bundle-reaval-3h",
        {
            "protocol_active": True,
            "item_checked": False,
    ...
    Vector(
        "pct-rising-tv2-no-fire-atb-too-early",
        "crit-sep-pct-rising",
    ...
    Vector(
        "pct-rising-tv3-no-fire-pct-falling",
        "crit-sep-pct-rising",
    ...
    Vector(
        "pct-rising-tv4-boundary-delta-0-25-no-fire",
        "crit-sep-pct-rising",
    ...
    Vector(
        "pct-rising-tv5-boundary-delta-0-26-fires",
        "crit-sep-pct-rising",
    ...
    Vector(
        "pct-deesc-tv1-fire-pct-low-stable",
        "crit-sep-pct-deesc",
    ...
    Vector(
        "pct-deesc-tv2-fire-pct-drop-85-percent",
        "crit-sep-pct-deesc",
    ...
    Vector(
        "pct-deesc-tv3-no-fire-unstable-patient",
        "crit-sep-pct-deesc",
    ...
    Vector(
        "pct-deesc-tv4-boundary-pct-0-25-no-fire",
        "crit-sep-pct-deesc",
    ...
    Vector(
        "pct-deesc-tv5-boundary-pct-0-24-fires",
        "crit-sep-pct-deesc",
...
async def test_golden_vector_parity(trilhas_engine: TrilhasEngine, vector: Vector) -> None:
