...
> **12 trilhas YAML** ativas hoje em `_work/alerts/pathways/`. O padrão genérico
> descrito abaixo não muda com a contagem. Ver `docs/audit/fullspectrum/DIM_A_TRACEABILITY.md` §4.4.
